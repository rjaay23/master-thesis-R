...
# Save results to csv
write.table(params_studentT, file="results/params_studentT300.csv", sep = ',', row.names = FALSE, col.names = FALSE)
...
# Save results to csv
write.table(params_studentT, file="results/params_studentT500.csv", sep = ',', row.names = FALSE, col.names = FALSE)
